 ...
 * This allow one PropertyValidator to validate multiple properties giving the
 ...
 * to create one PropertyValidator with a Postcode validator that is used by both
 * delivery and billing postcode.
 *
 * @param {Function} validator Validation function take a value to validate and returns a boolean
 */
var PropertyValidator = module.exports.PropertyValidator = function(validator) {
